class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) {
    return Item(
      item_id: json['item_id'] == null ? "" : json['item_id'] as String,
      item_name: json['item_name'] == null ? "" : json['item_name'] as String,
      item_category:
          json['item_category'] == null ? "" : json['item_category'] as String,
      item_price:
          json['item_price'] == null ? "" : json['item_price'] as String,
      item_address:
          json['item_address'] == null ? "" : json['item_address'] as String,
      item_contents:
          json['item_contents'] == null ? "" : json['item_contents'] as String,
      item_password:
          json['item_password'] == null ? "" : json['item_password'] as String,
